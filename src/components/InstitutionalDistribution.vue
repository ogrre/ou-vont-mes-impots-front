...
<template>
  <section class="home-section" aria-labelledby="who-spends-title">
    <div class="section-heading"><div><p class="eyebrow">Les acteurs <GlossaryInfo term="APU" /></p><h2 id="who-spends-title">{{ block.title }}</h2></div><QualityBadge :status="block.quality_status" :quality="block.quality" show-reason /></div>
